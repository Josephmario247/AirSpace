        ...
        {data ?
          <section className="px-4 py-5">
            ...
            <div className="container mx-auto flex-col py-4">
              ...
              full ? <div className="flex items-center rounded-md py-4 text-slate-700 gap-4 md:gap-8">
          ...
          <section className='px-4 py-5'>
            <h3 className='text-slate-800 texet-xl md:text-2xl text-center py-5'>{loading ?
              "Fetching House Details..." : "No record Found"}
            </h3>
          </section>
        }
      </main>
